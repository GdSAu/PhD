...
def GuardarDS(ds,I,i,obj_name,v_ini,v,octree, occupancy_probs, dir_carpeta, itera,cd, distance,cov):
    """
    ...
    """
    #Almacenamos Octree
    direccion_octree= bytes(dir_carpeta + "Octree/"+ itera +"octree_{}.ot".format(i), encoding='utf8')
    octree.writeBinary(direccion_octree) 
    np.save(dir_carpeta + "Octree/"+ itera +"grid_{}.npy".format(i),occupancy_probs, allow_pickle=True)
